...
public class GeminiService {
            ...
            Map<String, Object> body = Map.of(
                    "contents", List.of(
                            Map.of("parts", List.of(
                                    Map.of("text",
                                            "Analyze this image. Return strictly JSON with keys 'description' and 'tags' (list of 5)."),
    ...
    private GeminiResult parseGeminiResponse(String json) throws Exception {
        ...
        if (!root.has("candidates") || !root.path("candidates").isArray() || root.path("candidates").isEmpty()) {
            throw new RuntimeException(
                    "AI response is missing 'candidates' field or it's empty. Full response: " + json);
        }
        ...
        if (!firstCandidate.has("content") || !firstCandidate.path("content").has("parts") ||
            ...
            throw new RuntimeException("AI response is missing 'parts' field or it's empty. Full response: " + json);
        }
